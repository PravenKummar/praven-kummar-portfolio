...
### Local Path
```
/Users/praven/Desktop/my-budget-app/praven-kummar-portfolio/
```
...
| Great Eastern Life Sdn Bhd | Vice President, IT Project Manager | May 2021 - Dec 2023 |
| Techlab Security Sdn Bhd | IT Cyber Security Project Manager | Apr 2019 - May 2021 |
...
3. **Regional Cybersecurity Enhancement** - $2M USD, Great Eastern (5 countries)
4. **Single Sign-On Integration** - 58 apps, Malaysia Airlines
5. **Thycotic PAM Implementation** - 1,018 servers, Genting (5 years)
6. **Lens Order Database (LODB)** - €80K savings, Carl Zeiss (8 countries)
7. **IBM QRadar SIEM - Bank Negara** - 26 servers, Central Bank
...
| Name | Hex | Usage |
|------|-----|-------|
| Brand Navy | #003366 | Primary color, headers, buttons |
| Brand Slate | #708090 | Secondary text |
| Brand Light | #f8fafc | Backgrounds |
| Brand Dark | #1e293b | Dark accents |
...
| Setting | Value |
|---------|-------|
| Repository | PravenKummar/praven-kummar-portfolio |
| Branch | master |
| Path | / (root) |
| HTTPS | Enforced |
